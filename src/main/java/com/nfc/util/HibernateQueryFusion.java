 ...
 * @author NFC
 */
public class HibernateQueryFusion {

    static Logger logger = Logger.getLogger(HibernateQueryFusion.class);
	...
	public List<Object[]> getQueryResultFromSession(String Query) {
        ...
        try {
            session = HibernateUtil.getROFusionSessionFactory().openSession();
            ...
            java.util.logging.Logger.getLogger(HibernateQueryFusion.class.getName()).log(Level.SEVERE, null, e);
    ...
    public String getStringFromFussionSession(String query) {
        Session session = null;
        String result = " ";
        try {
            session = HibernateUtil.getROFusionSessionFactory().openSession();
    ...
    public List createQueryAndGetListFromFussion(String query) {
        Session session = null;
    ...
    public Integer deleteExistingAndSaveListOfObjectsToFusionTable(String tableName, String columnName, String columnValue, List objList) {
        Integer result = 0;
    ...
    public Integer deleteExistingAndSaveListOfObjectsToFusionTable(String tableName, String columnName, int columnValue, List objList) {
        Integer result = 0;
    ...
    public Integer deleteExistingAndSaveListOfObjectsToFusionTable(String tableName, String deleteCondition, List objList) {
        Integer result = 0;
    ...
    public Integer executeUpdateQueryOnFusionTable(String query) {
        Integer result = 0;
